<?php
    ...
    $query = "SELECT * FROM jenis_laundry";
    $sql = mysqli_query($conn, $query);

    $query2 = "SELECT * FROM pesanan WHERE id_pesanan = $id";
                ...
                <main>
                    <div class="container-fluid px-4">
                        ...
                        <div class="card mb-4">
                            ...
                            <div class="card-body">
                            <form method="post" action="include/process/update_pesanan.php">
                                <input type="hidden" name="id_pesanan" value="<?= $data2['id_pesanan'] ?>">
                                <?php if($_SESSION['level'] == 'pelanggan'){ ?>
                                    <div class="form-group">
                                        <label class="small mb-1" for="inputJL">Jenis Laundry</label>
                                        <select id="inputJL" class="form-select" name="jenis" required>
                                            <?php while($data = mysqli_fetch_array($sql)){
                                                if($data2['id_jenis'] == $data['id_jenis']){
                                                ?>
                                                <option value="<?= $data['id_jenis'] ?>" selected><?= $data['jenis'] ?></option>
                                                <?php } else { ?>
                                    ...
                                    <br>
                                    <div class="form-group">
                                        <label class="small mb-1" for="inputJumlah">Berat</label>
                                        <input class="form-control" name="jumlah" id="inputJumlah" type="number" placeholder="Berat/Kg" min="0" value="<?= $data2['berat'] ?>" />
                                    </div>
                                    <br>
                                ...
                                <?php } else { ?>
                                    <div class="form-group">
                                        <label class="small mb-1" for="inputSt">Status</label>
                                        <select id="inputSt" class="form-select" name="status" required>
                                            ...
                                            <?php } else if($data2['status'] == 'selesai') { ?>
                                                ...
                                                <option value="batal">Batal</option>
                                            <?php } else if($data2['status'] == 'batal') { ?>
                                                <option value="proses">Proses</option>
                                                <option value="selesai">Selesai</option>
