                    ...
                    <div class="container-fluid px-4">
                        ...
                        <div class="card mb-4">
                            <div class="card-header d-flex">
                                ...
                                <div>
                                    <a href="add_pegawai.php"><button class="btn btn-primary">Tambah</button></a>
                                </div>
                            </div>
                            <div class="card-body">
                                <table id="datatablesSimple">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td> <?= $data2['alamat']?> </td>
                                            <td align="center"> <?= $data2['level']?> </td>
                                            <td align="center">
                                                    <a href="include/process/delete_pegawai.php?id_users=<?=$data2['id_users'];?>"><button class="btn btn-danger mx-1"><i class="fas fa-trash"></i></button></a>
