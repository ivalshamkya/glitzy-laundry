                ...
                <main>
                    <div class="container-fluid px-4">
                        ...
                        <div class="card mb-4">
                            ...
                            <div class="card-body">
                                <form class="row g-3" action="include/process/tambah_pegawai.php" method="POST">
                                    <div class="col-md-6">
                                        <label for="input" class="form-label">Users</label>
                                        <select id="input" class="form-select" name="id_users" required>
                                            <option selected disabled>-- Select --</option>
                                            <?php while($data = mysqli_fetch_array($sql)){
                                                $id = $data['id_users'];
                                                $query2 = "SELECT * FROM pegawai WHERE id_users = $id";
                                                $sql2 = mysqli_query($conn, $query2);
                                                $cek = mysqli_num_rows($sql2);

                                                if($cek < 1){
                                                ?>
                                                <option value="<?= $data['id_users']?>"><?= $data['username'] ?></option>
                                            <?php }} ?>
                                        </select>
                                    </div>
                                    <div class="col-12">
