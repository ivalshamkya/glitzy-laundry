                ...
                <main>
                    <div class="container-fluid px-4">
                        ...
                        <ol class="breadcrumb mb-4">
                            <li class="breadcrumb-item active">Table Jenis Laundry</li>
                        </ol>
                        <div class="card mb-4">
                            <div class="card-header d-flex">
                                ...
                                <div>
                                    <a href="add_jenis_laundry.php"><button class="btn btn-primary">Tambah</button></a>
                                </div>
                            </div>
                            <div class="card-body">
                                <table id="datatablesSimple">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td> <?= $data['harga']?> </td>
                                            <td align="center">
                                                    <a href="include/process/delete_jenis_laundry.php?id_jenis=<?=$data['id_jenis'];?>"><button class="btn btn-danger mx-1"><i class="fas fa-trash"></i></button></a>
