                ...
                <main>
                    <div class="container-fluid px-4">
                        ...
                        <div class="card mb-4">
                            ...
                            <div class="card-body">
                                <form method="post" action="include/process/tambah_pesanan.php">
                                    <div class="form-group">
                                        <label class="small mb-1" for="inputJK">Jenis Laundry</label>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input class="form-control" name="jumlah" id="inputJumlah" type="number" placeholder="Berat/Kg" min="0" />
                                    </div>
                                    <br>
